...
<footer id="footer">
  <ul class="icons">
    ...
    <li><a href="http://www.adidas.fr" rel="nofollow"><i class="sprite sprite-adidas"></i></a></li>
    <li><a href="http://www.auvieuxcampeur.fr" rel="nofollow"><i class="sprite sprite-vieux-campeur"></i></a></li>
    <li><a href="http://www.petzl.com" rel="nofollow"><i class="sprite sprite-petzl"></i></a></li>
    <li><a href="http://www.expe.fr" rel="nofollow"><i class="sprite sprite-expe"></i></a></li>
    <li><a href="http://www.scarpa.net" rel="nofollow"><i class="sprite sprite-scarpa"></i></a></li>
    <li><a href="http://www.andrea-boldrini.com" rel="nofollow"><i class="sprite sprite-andrea-boldrini"></i></a></li>
    ...
    <li><a href="http://www.lechaussemontagne.fr" rel="nofollow"><i class="sprite sprite-canin"></i></a></li>
    <li><a href="http://www.banque-rhone-alpes.fr" rel="nofollow"><i class="sprite sprite-banque-rhone-alpes"></i></a></li>
