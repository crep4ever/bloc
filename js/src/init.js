...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global: { href: 'css/style.min.css', containers: 1400, grid: { gutters: ['2em', 0] } },
			xlarge: { media: '(max-width: 1680px)', href: 'css/style-xlarge.min.css', containers: 1200 },
			large: { media: '(max-width: 1280px)', href: 'css/style-large.min.css', containers: 960, grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
