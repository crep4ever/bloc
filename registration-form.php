...
$(function() {
    ...
    var availableClubs = ["ACS SAVOIE TECHNOLAC", "A.S. VILLEFONTAINE", "ASVEL SKI MONTAGNE", "ACCRO-ROC", "ALBERTVILLE ESCALADE",
			  ...
			  "BREDAROC", "BRON VERTICAL", "CAF ALBERTVILLE", "CAF ANNECY COMPETITION", "CAF FAVERGES COMP", "CAF SALEVE ANNEMASSE", "CODC ESCALADE",
...
"CROLLES GRESIVAUDAN ESCALADE", "CHAMBERY ESCALADE", "TIRE-CLOUS DU GRAND MONTI", "SARL CULTURE ROC", "ESCALADE VOIRON ALPINISME", "LIBRE ECART MARIGNIER", "ROC EVASION", "ESCALADE CLUB LA TRONCHE", "MOUSTE'CLIP", "CANTON GRIMP'", "BRON VERTICAL",
"AS VILLEFONTAINE", "FRATERN BOURGOIN", "CAF LA ROCHETTE", "ART BLOC", "GRIMP ALTITUDE", "CAF EMBRUN", "ESCAPILADE", "CAF FAVERGES", "CARROZ VERTICAL", "CANYON ESCALADE TOURAINE", "GROUPE MONTAGNARD PETITES ROCHES", "CAF SALEVE ANNEMASSE", "CLUB EYBENS", "PIED MAIN ESCALADE"];
    ...
    <div>
      ...
      <p>Cette indication servira à répartir les compétiteurs dans les
