...
$(function() {
    ...
    var availableClubs = ["ACS SAVOIE TECHNOLAC", "ASVEL SKI MONTAGNE", "ACCRO-ROC", "ALBERTVILLE ESCALADE",
			  ...
			  "GROUPE MONTAGNARD PETITES ROCHES", "CAF SALEVE ANNEMASSE", "CLUB EYBENS", "PIED MAIN ESCALADE", "MINERAL SPIRIT", "ESCAPADE", "LES LEZARDS VAGABONDS", "FOURNEL ARGENTIERE", "ASPTT GAP", "VERTIGE", "LA DEGAINE", "MROC"];
