...
$(function() {
    ...
    var availableClubs = ["ACS SAVOIE TECHNOLAC", "ASVEL SKI MONTAGNE", "ACCRO-ROC", "ALBERTVILLE ESCALADE",
			  ...
			  "CROLLES GRESIVAUDAN ESCALADE", "CHAMBERY ESCALADE", "TIRE-CLOUS DU GRAND MONTI", "SARL CULTURE ROC", 
			  ...
			  "GROUPE MONTAGNARD PETITES ROCHES", "CAF SALEVE ANNEMASSE", "CLUB EYBENS", "PIED MAIN ESCALADE", "MINERAL SPIRIT", "ESCAPADE", "LES LEZARDS VAGABONDS", "FOURNEL ARGENTIERE", "ASPTT GAP", "VERTIGE", "LA DEGAINE", "MROC", "UNSS"];
